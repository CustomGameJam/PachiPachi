...
public class Client : MonoBehaviour
{
    ...
    private void ListenForData()
    {
        try
        {
            socketConnection = new TcpClient("192.168.3.120", 3131);
                    ...
                    while ((length = stream.Read(bytes, 0, bytes.Length)) != 0)
                    {
                        ...
                        switch (parts[0])
                        {
                            ...
                            case "boom":
                                ...
                                break;
                            case "change":
                                _gameManager.CreateAction(ActionType.Boom, parts[1], int.Parse(parts[2]),count: int.Parse(parts[3]));
                                break;
                        }
                    }
                }
